...
import com.api.authentication.security.LoginRequestDto;
import com.api.authentication.security.MainUser;
...
//bean para la creacion del token

    private final static String SECRET_KEY = "secrettoken";
