...
import com.api.authentication.jwt.JwtTokenDto;
import com.api.authentication.jwt.JwtToken;
...
//controlador para manejar las peticiones de autenticacion y permisos
    ...
    public ResponseEntity<JwtTokenDto> login(@RequestBody LoginRequestDto loginRequestDto) {
        ...
        try {
            ...
            JwtTokenDto jwtTokenDto = new JwtTokenDto(jwt, user.getUsername(), user.getFullName(), user.getUserId(), user.getAuthorities());
